...
import { EditIcon, MailIcon, PhoneIcon, WalletIcon } from 'lucide-react';
      ...
      {userStatus === 'success' && user && authUser && (
        <>
          <div className="flex w-full items-center justify-between whitespace-nowrap p-4">
            ...
            <a href="#">
              <EditIcon className="aspect-square" height={20} width={20} />
            </a>
          </div>
          ...
          <div className="w-full rounded-xl bg-white p-4">
            ...
            <div className="mt-2 flex w-full flex-row items-center justify-between">
              <div className="flex flex-row space-x-2">
                <WalletIcon className="aspect-square" size={20} />
